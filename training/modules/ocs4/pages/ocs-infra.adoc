...
ip-10-0-129-227.eu-central-1.compute.internal   Ready    worker         102m   v1.19.0+e49167a
ip-10-0-166-96.eu-central-1.compute.internal    Ready    worker         102m   v1.19.0+e49167a
ip-10-0-194-74.eu-central-1.compute.internal    Ready    worker         102m   v1.19.0+e49167a
----
...
openshift-machine-api   enel-test-826c5-worker-eu-central-1a      1         1         1       1           116m
openshift-machine-api   enel-test-826c5-worker-eu-central-1b      1         1         1       1           116m
openshift-machine-api   enel-test-826c5-worker-eu-central-1c      1         1         1       1           116m
----
...
Having taken inspiration from here `https://docs.openshift.com/container-platform/4.5/machine_management/creating-infrastructure-machinesets.html`

Create new *MachineSets* that will run
storage-specific *infra* nodes for your OCP cluster:

[source,role="execute"]
----
curl -s https://raw.githubusercontent.com/mikelo/ocs-training/master/training/modules/ocs4/attachments/cluster-workerocs-eu-central-1-infra.yaml | sed -e "s/CLUSTERID/${CLUSTERID}/g" | sed -e "s/RHCOS/${RHCOS}/g" | oc apply -f -
----
...
enel-test-khzh4-infra-eu-central-1a-qkkpx       Running    m5.large     eu-central-1   eu-central-1a   18m
enel-test-khzh4-master-0                        Running    m5.xlarge    eu-central-1   eu-central-1a   29h
enel-test-khzh4-master-1                        Running    m5.xlarge    eu-central-1   eu-central-1b   29h
enel-test-khzh4-master-2                        Running    m5.xlarge    eu-central-1   eu-central-1c   29h
enel-test-khzh4-worker-eu-central-1a-6f7sn      Running    m5.large     eu-central-1   eu-central-1a   29h
enel-test-khzh4-worker-eu-central-1b-lt4fm      Running    m5.large     eu-central-1   eu-central-1b   29h
enel-test-khzh4-worker-eu-central-1c-rs7jd      Running    m5.large     eu-central-1   eu-central-1c   29h
enel-test-khzh4-workerocs-eu-central-1a-lp9h8   Running    m5.4xlarge   eu-central-1   eu-central-1a   24h
enel-test-khzh4-workerocs-eu-central-1b-bn2cq   Running    m5.4xlarge   eu-central-1   eu-central-1b   24h
enel-test-khzh4-workerocs-eu-central-1c-vwss7   Running    m5.4xlarge   eu-central-1   eu-central-1c   24h
...
openshift-machine-api   enel-test-826c5-worker-eu-central-1b      1         1         1       1           116m
openshift-machine-api   enel-test-826c5-worker-eu-central-1c      1         1         1       1           116m
openshift-machine-api   enel-test-826c5-workerocs-eu-central-1a   1         1         1       1           75m
openshift-machine-api   enel-test-826c5-workerocs-eu-central-1b   1         1         1       1           75m
openshift-machine-api   enel-test-826c5-workerocs-eu-central-1c   1         1         1       1           75m
----
...
NAME                                            STATUS   ROLES          AGE    VERSION
ip-10-0-129-227.eu-central-1.compute.internal   Ready    worker         102m   v1.19.0+e49167a
ip-10-0-132-238.eu-central-1.compute.internal   Ready    master         109m   v1.19.0+e49167a
ip-10-0-139-155.eu-central-1.compute.internal   Ready    infra,worker   68m    v1.19.0+e49167a
ip-10-0-166-96.eu-central-1.compute.internal    Ready    worker         102m   v1.19.0+e49167a
ip-10-0-167-222.eu-central-1.compute.internal   Ready    master         108m   v1.19.0+e49167a
ip-10-0-189-227.eu-central-1.compute.internal   Ready    infra,worker   68m    v1.19.0+e49167a
ip-10-0-194-74.eu-central-1.compute.internal    Ready    worker         102m   v1.19.0+e49167a
ip-10-0-223-47.eu-central-1.compute.internal    Ready    master         109m   v1.19.0+e49167a
ip-10-0-223-56.eu-central-1.compute.internal    Ready    infra,worker   68m    v1.19.0+e49167a
----
...
// ----
// NAME                                         STATUS   ROLES    AGE   VERSION
// ip-10-0-147-230.eu-central-1.compute.internal   Ready    worker   15m   v1.19.0+9f84db3
// ip-10-0-175-8.eu-central-1.compute.internal     Ready    worker   15m   v1.19.0+9f84db3
// ip-10-0-209-53.eu-central-1.compute.internal    Ready    worker   15m   v1.19.0+9f84db3
// ----
...
[source,role="execute"]
----
oc apply -f https://raw.githubusercontent.com/mikelo/ocs-training/master/training/modules/ocs4/attachments/cluster-monitoring-configmap.storage.yaml
----
...
We are following this blog here and we add a few adjustments to the YAML file and the testing scripts:
...
[source,role="execute"]
----
oc apply -f https://raw.githubusercontent.com/mikelo/ocs-training/master/training/modules/ocs4/attachments/OCS-FS-STS.yaml
----
...
----
NAME                       READY   STATUS        RESTARTS   AGE
mysql-ocs-fs-0             0/2     Running       0          29m
mysql-ocs-fs-1             0/2     Running       0          29m
mysql-ocs-fs-10            0/2     Running       0          29m
mysql-ocs-fs-11            0/2     Running       0          29m
mysql-ocs-fs-12            0/2     Running       0          29m
mysql-ocs-fs-13            0/2     Running       0          29m
mysql-ocs-fs-14            0/2     Running       0          29m
mysql-ocs-fs-15            0/2     Running       0          29m
mysql-ocs-fs-16            0/2     Running       0          29m
mysql-ocs-fs-17            0/2     Running       0          29m
mysql-ocs-fs-18            0/2     Running       0          29m
mysql-ocs-fs-19            0/2     Running       0          29m
mysql-ocs-fs-2             0/2     Running       0          29m
mysql-ocs-fs-3             0/2     Running       0          29m
mysql-ocs-fs-4             0/2     Running       0          29m
mysql-ocs-fs-5             0/2     Running       0          29m
mysql-ocs-fs-6             0/2     Running       0          29m
mysql-ocs-fs-7             0/2     Running       0          29m
mysql-ocs-fs-8             0/2     Running       0          29m
mysql-ocs-fs-9             0/2     Running       0          29m
...
Events:
  ...
  Normal   FileSystemResizeSuccessful  23s   kubelet, ip-10-0-199-224.eu-central-1.compute.internal                                                                 MountVolume.NodeExpandVolume succeeded for volume "pvc-4d6838df-b4cd-4bb1-9969-1af93c1dc5e6"
----
...
5712529.eu-central-1.elb.amazonaws.com:443]
ExternalIP  : []
...
eu-central-1.elb.amazonaws.com:443]
ExternalIP  : []
...
cluster-ocs4-8613-bc282-workerocs-eu-central-1a   1         1         1       1           2d
cluster-ocs4-8613-bc282-workerocs-eu-central-1b   1         1         1       1           2d
cluster-ocs4-8613-bc282-workerocs-eu-central-1c   1         1         1       1           2d
----
...
.Example output:
----
oc scale -n openshift-machine-api --replicas=2 machineset.machine.openshift.io/cluster-ocs4-8613-bc282-workerocs-eu-central-1a
machineset.machine.openshift.io/cluster-ocs4-8613-bc282-workerocs-eu-central-1a scaled
oc scale -n openshift-machine-api --replicas=2 machineset.machine.openshift.io/cluster-ocs4-8613-bc282-workerocs-eu-central-1b
machineset.machine.openshift.io/cluster-ocs4-8613-bc282-workerocs-eu-central-1b scaled
oc scale -n openshift-machine-api --replicas=2 machineset.machine.openshift.io/cluster-ocs4-8613-bc282-workerocs-eu-central-1c
machineset.machine.openshift.io/cluster-ocs4-8613-bc282-workerocs-eu-central-1c scaled
----
...
.Example output:
----
ip-10-0-147-230.eu-central-1.compute.internal
ip-10-0-157-22.eu-central-1.compute.internal
ip-10-0-175-8.eu-central-1.compute.internal
ip-10-0-183-84.eu-central-1.compute.internal
ip-10-0-209-53.eu-central-1.compute.internal
ip-10-0-214-36.eu-central-1.compute.internal
----
...
2.compute.internal
rook-ceph-osd-1-6f49b665c7-gxq75            Running     ip-10-0-209-53.eu-central-1
.compute.internal
rook-ceph-osd-2-76ffc64cd-9zg65             Running     ip-10-0-175-8.eu-central-1.
compute.internal
rook-ceph-osd-3-97b5d9844-jpwgm             Running     ip-10-0-157-22.eu-central-1
.compute.internal
rook-ceph-osd-4-9cb667b76-mftt9             Running     ip-10-0-214-36.eu-central-1
.compute.internal
rook-ceph-osd-5-55b8d97855-2bp85            Running     ip-10-0-157-22.eu-central-1
.compute.internal
----
